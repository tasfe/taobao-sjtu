package edu.fudan.autologin.main;
...
public class Tbfetcher {
	private static final Logger log = Logger.getLogger(Tbfetcher.class);
...
//		for (int i = 1; i < searchResultSheet.getRows(); i++) {
	...
	public static void main(String[] args) {
		...
		Tbfetcher tbfetcher = new Tbfetcher();
		tbfetcher.execute();
	}
